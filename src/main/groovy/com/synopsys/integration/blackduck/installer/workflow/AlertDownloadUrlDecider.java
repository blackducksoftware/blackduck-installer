...
public class AlertDownloadUrlDecider implements DownloadUrlDecider {
    ...
    public AlertDownloadUrlDecider(DownloadSource downloadSource, String version, String githubDownloadUrlPrefix, String artifactoryUrl, String artifactoryRepo, String artifactoryPath, String artifact) {
    ...
    public Optional<String> determineDownloadUrl() throws BlackDuckInstallerException {
        if (DownloadSource.GITHUB == downloadSource) {
            return Optional.of(new AlertGithubDownloadUrl(githubDownloadUrlPrefix, version).getDownloadUrl());
