...
public class OpenSslOutputParser {
    ...
    public String parseCertificateOutput(String fullOutput) {
        return fullOutput.substring(fullOutput.indexOf(START_TOKEN), fullOutput.indexOf(END_TOKEN) + END_TOKEN.length());
    }
