...
public class PreComputedHashes {
    ...
    //alert 6.0.0
    public static final String ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_6_0_0 = "b40d870285a2c2c712674efc6e1f3fb3046718d3d56c2b5cbad2dbbbd06db82b";

    //alert 6.0.1
    public static final String ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_6_0_1 = "b40d870285a2c2c712674efc6e1f3fb3046718d3d56c2b5cbad2dbbbd06db82b";

    //alert 6.1.0
    public static final String ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_6_1_0 = "b40d870285a2c2c712674efc6e1f3fb3046718d3d56c2b5cbad2dbbbd06db82b";

    //alert 6.2.0
    public static final String ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_6_2_0 = "c6fbe0c526590bd9ad6fdda8a7841abb2659dd8aa71524e5c19fdb83f3baf793";
    ...
    static {
        ...
        ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML.add(ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_6_0_0);
        ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML.add(ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_6_0_1);
        ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML.add(ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_6_1_0);
        ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML.add(ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_6_2_0);
    }
