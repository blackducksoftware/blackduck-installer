...
public class PreComputedHashes {
    ...
    public static final Set<String> HUB_WEBSERVER_ENV = Set.of(HUB_WEBSERVER_ENV_2019_8_1, HUB_WEBSERVER_ENV_2019_10_0, HUB_WEBSERVER_ENV_2019_10_1, HUB_WEBSERVER_ENV_2019_12_0);
    public static final Set<String> DOCKER_COMPOSE_LOCAL_OVERRIDES_YML = Set.of(DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_2019_8_1, DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_2019_10_0, DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_2019_10_1, DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_2019_12_0);
    public static final Set<String> BLACKDUCK_CONFIG_ENV = Set.of(BLACKDUCK_CONFIG_ENV_2019_8_1, BLACKDUCK_CONFIG_ENV_2019_10_0, BLACKDUCK_CONFIG_ENV_2019_10_1, BLACKDUCK_CONFIG_ENV_2019_12_0);

    public static final Set<String> ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML = Set.of(ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_5_0_0, ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_5_0_1, ALERT_DOCKER_COMPOSE_LOCAL_OVERRIDES_YML_5_1_0);
